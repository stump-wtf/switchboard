...
//
// An empty SWITCHBOARD_SECRET_ENCRYPTION_KEY leaves secrets unencrypted at rest: self-managed
...
//
// Scope: the self-managed webhook signing secret, the only secret switchboard holds. For a while
// there was a second class — the instance-wide provider registry's secrets (#242) — and this file
// warned about those too; the registry was removed in #181 and its half of this file went with it.
//
...
//
// @joestump 09/21/2026 - Removed the provider-registry half with the registry itself (#181).
