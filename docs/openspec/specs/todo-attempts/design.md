...
SPEC-0013 (todo drawer), SPEC-0023 (metrics). Companion records accepted on 2026-09-22: SPEC-0033
(teams), SPEC-0029 (notification sinks), SPEC-0024 (notify hooks), SPEC-0030 (admission). Cross-product:
Harness SPEC-0019 (the first consumer).
...
- **Should a human's Board claim be able to request a fence?** Resolved (design review 2026-09-22): no, not needed today.
