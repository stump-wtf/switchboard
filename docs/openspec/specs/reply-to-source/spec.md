...
ADR-0038 and SPEC-0033 (Teams and tenancy, in flight). Until they merge, "owner scope" means the owning
human, and every requirement below that names a team applies once teams exist.
