...
related: [SPEC-0019, SPEC-0022, SPEC-0023, SPEC-0025, SPEC-0026, SPEC-0030, SPEC-0033]
---
...
`ceiling_exceeded` and persist nothing. A ceiling of `0` MUST also stop dispatch to every existing
hook, and Switchboard MUST log one startup line saying notify hooks are disabled.
...
that means synthetic self-test todos ([SPEC-0025](../doorbell-acknowledgement/spec.md)) and
quarantined deliveries ([SPEC-0026](../trusted-intake/spec.md)).
