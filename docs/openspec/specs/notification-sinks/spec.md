...
date: 2026-09-22
implements: [ADR-0034]
requires: [SPEC-0003, SPEC-0020, SPEC-0022, SPEC-0023, SPEC-0028]
related: [SPEC-0025, SPEC-0026, SPEC-0030, SPEC-0033, SPEC-0034]
---
...
Sink credentials are rows in the connection vault that [SPEC-0028](../reply-to-source/spec.md) (reply
to source) defines; this spec adds the `gotify` and `apprise` kinds to it. The owner shape and team
roles come from [SPEC-0033](../teams-tenancy/spec.md) (Teams and tenancy). Event sources defined
elsewhere: quarantine (SPEC-0026), unheard doorbells (SPEC-0025), attempt history (SPEC-0034), admission
budgets (SPEC-0030), and Harness relay attempts (Harness SPEC-0019). Until each is implemented, the
requirements that depend on it apply once it is, and its digest section reads "unavailable".
