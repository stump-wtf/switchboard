...
related: [ADR-0002, ADR-0013, ADR-0027, ADR-0028, ADR-0029, ADR-0034, ADR-0038, ADR-0039]
---
...
* **Companion records.** Teams and the queue-identity contract are in ADR-0038 / SPEC-0033. Attempt history is in ADR-0039 / SPEC-0034. The notify-hook spec is SPEC-0024. Notification sinks and the digest are in ADR-0034 / SPEC-0029. They were accepted together on 2026-09-22 and are linked as front-matter edges.
* **Out of scope.** Operator-imposed ceilings on a tenant (for example, an instance maximum of claims per owner per day) are a different control. ADR-0038 lets the operator bound tenant usage but not configure it, and that belongs in its own record. Priority and fair share across queues stay deferred, as the dispatch backlog says.
