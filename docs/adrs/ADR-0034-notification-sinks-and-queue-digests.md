...
extends: [ADR-0024]
related: [ADR-0013, ADR-0022, ADR-0027, ADR-0028, ADR-0029]
---
...
* Parallel records, cited by number until they merge: ADR-0030 and SPEC-0025 (unheard doorbells);
  ...
  ADR-0035 and SPEC-0030 (admission control, whose deferred work the digest reports); Harness ADR-0025
and SPEC-0019 (relay attempts).
