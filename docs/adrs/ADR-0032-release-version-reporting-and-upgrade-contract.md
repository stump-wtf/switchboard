...
related: [ADR-0005, ADR-0023, ADR-0028, ADR-0030]
---
...
Switchboard has cut two releases, `v0.1.0` and `v0.2.0` (2026-09-15). `main` is 22 commits past
`v0.2.0` as of 2026-09-22, and the gap grows with every merge. Those commits include a breaking removal, a behaviour change every client notices, and a
...
* Companion records, accepted together on 2026-09-22 and linked as front-matter edges: ADR-0030 / SPEC-0025 (`switchboard doctor`
